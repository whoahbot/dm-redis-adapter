...
Set up namespaces in Redis database to separate data on different stages. Taking default naming convention and prefixing it with application name and environment, for example <code>great_app:development:users</code>
