...
This is an experimental datamapper adapter for the <a href="http://code.google.com/p/redis/wiki/README">Redis</a> key-value db.  The primary goal is to get all shared adapter specs to pass, then optimize for speed.
